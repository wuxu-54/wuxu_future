...
- [mc](https://github.com/alibaba/arthas/blob/master/site/src/site/sphinx/mc.md)——内存编绎器，内存编绎.java文件为.class文件
- [redefine](https://github.com/alibaba/arthas/blob/master/site/src/site/sphinx/redefine.md)——加载外部的.class文件，redefine到JVM里
...
------
著作权归@pdai所有
原文链接：<https://pdai.tech/md/java/jvm/java-jvm-agent-arthas.html>

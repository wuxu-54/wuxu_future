...
>本文是最原始的开发插件的配置方法，更具体的实战开发可以看[java-gradle-plugin](../3.%E4%B8%89%E6%96%B9%E6%8F%92%E4%BB%B6/1.java-gradle-plugin.md)章节，此章节讲的是我们常用的开发插件的配置方式。
...
4. **创建插件的标识文件**：
    >高版本gradle有专门的api :`gradlePlugin`，配置后可以自动生成下面的文件，在`build/resources`目录下可以看到。
